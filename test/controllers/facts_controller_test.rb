...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { body: @fact.body, picture: @fact.picture, preview: @fact.preview, title: @fact.title }
    end
  ...
  test "should update fact" do
    patch :update, id: @fact, fact: { body: @fact.body, picture: @fact.picture, preview: @fact.preview, title: @fact.title }
    assert_redirected_to fact_path(assigns(:fact))
  end
