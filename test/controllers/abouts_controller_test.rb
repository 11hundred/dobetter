...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { body: @about.body, extras: @about.extras, headline: @about.headline, title: @about.title }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { body: @about.body, extras: @about.extras, headline: @about.headline, title: @about.title }
    assert_redirected_to about_path(assigns(:about))
  end
